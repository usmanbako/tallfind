...
(function () {
    ...
    var headerHTML =
        ...
        +   '<a class="pill pill-sm" href="/?tab=all">All</a>'
        ...
        +   '<input type="text" id="searchShortcut" placeholder="Search by store, size, inseam..." readonly onclick="location.href=\'/?tab=all\'">'
        + '</div>'
    ...
    function footerHTML() {
        return '<footer class="hp-footer">'
            ...
            +       '<h5>Directory</h5>'
            +       '<ul>'
            +         '<li><a href="/?tab=all">All Stores</a></li>'
